...
That should give you an idea of the main features of Shiny. Of course, there’s much more to learn. A good place to look is Hadley Wickham’s [https://mastering-shiny.org/index.html](Mastering Shiny) book, particularly [https://mastering-shiny.org/basic-ui.html](Chapter 2), which runs through the main UI components that you’ll need for building apps, and [https://mastering-shiny.org/basic-case-study.html](Chapter 4) that provides an example of a more complex Shiny app using medical data. As usual, Posit provide a very handy [https://rstudio.github.io/cheatsheets/html/shiny.html](cheat sheet).
